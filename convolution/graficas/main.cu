...
void convolution_serial(int** dd_mat_a, int n_rows_a, int n_cols_a ,double** dd_mat_b, int n_rows_b, int n_cols_b, int** dd_mat_c, int n_rows_c, int n_cols_c){
...
*/
	...
	//printf("%.25f,%.25f",time1/1000,time_spent);
